		...
		<div id="list-city" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="city.district.label" default="District" /></th>
				...
				<g:each in="${cityInstanceList}" status="i" var="cityInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${cityInstance.id}">${fieldValue(bean: cityInstance, field: "district")}</g:link></td>
