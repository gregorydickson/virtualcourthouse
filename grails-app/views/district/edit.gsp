...
<html>
	...
	<body>
		<a href="#edit-district" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-district" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:districtInstance, action:'update']" method="PUT" >
