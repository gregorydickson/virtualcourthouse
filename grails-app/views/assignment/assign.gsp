		...
		<div id="edit-assignment" class="content scaffold-edit" role="main">
			...
			<g:form action="update" >
				...
				<div >
					...
					<g:select id="indexer" name="indexer.id" from="${net.rcenergy.User.list()}" optionValue="username" optionKey="id" required="" value="${assignmentInstance?.indexer?.id}" class="many-to-one" />
				</div>
				</fieldset>
